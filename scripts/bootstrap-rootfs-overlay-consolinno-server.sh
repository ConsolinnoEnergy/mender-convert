...
{
    "ArtifactVerifyKey": "/etc/mender/artifact-verify-key.key",
    ...
    "UpdatePollIntervalSeconds": 21600,
    "InventoryPollIntervalSeconds": 14400,
    "RetryPollIntervalSeconds": 30,
    "StateScriptTimeoutSeconds": 600,
    "StateScriptRetryTimeoutSeconds": 345600,
    "StateScriptRetryIntervalSeconds": 5
}
